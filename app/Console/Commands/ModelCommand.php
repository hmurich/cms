...
class ModelCommand extends GeneratorCommand {
    ...
    protected function buildClass($name)
    {
        ...
        return $this->replaceNamespace2($stub, $name)->replaceTable($stub, $table)->replaceFillable($stub, $table)->replaceClass($stub, $name);
    }
    ...
    protected function replaceNamespace2(&$stub, $name)
    {
        $name = explode('\\', $name);
